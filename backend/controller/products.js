...
class Product {
  ...
  async getProductsGroupedByCategory(req, res) {
    try {
      let products = await productModel.find({}).populate("pCategory", "cName");
      let groupedProducts = {};
  
      products.forEach(product => {
        const category = product.pCategory.cName;
      ...
      return res.json({ categorizedProducts: groupedProducts });
    } catch (err) {
      console.log(err);
